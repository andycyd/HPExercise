...
const getAlbums = async (req, res, next) => {
    ...
    try {
        const albums = filterDuplicatesByName(await fetchAlbumsFromItunes(artist));
...
const filterDuplicatesByName = (albums) => {
    return _.uniqBy(albums, album => album.title.toLowerCase());
};
